...
// in weather_app_ddd/test/infrastructure/auth/mock_firebase_auth_provider.dart.
...
import 'mock_firebase_auth_provider.dart' as _i4;
...
class MockFirebaseAuthProvider extends _i1.Mock
    implements _i4.FirebaseAuthProvider {
...
/// A class which mocks [MockAuthUser].
///
/// See the documentation for Mockito's code generation for more information.
class MockMockAuthUser extends _i1.Mock implements _i4.MockAuthUser {
  MockMockAuthUser() {
    _i1.throwOnMissingStub(this);
  }
